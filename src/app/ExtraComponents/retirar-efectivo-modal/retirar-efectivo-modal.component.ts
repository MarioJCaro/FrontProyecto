...
@Component({
  selector: 'app-retirar-efectivo-modal',
  templateUrl: './retirar-efectivo-modal.component.html',
  styleUrls: ['./retirar-efectivo-modal.component.scss']
})
export class RetirarEfectivoModalComponent {
  form: FormGroup;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<RetirarEfectivoModalComponent>
    ) {
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.movimientoService.post(data).subscribe({
        ...
        this.toastService.showSuccess("Retiro realizado con éxito");
           // Cierra el modal
        ...
        error:error => {
          ...
          this.toastService.showError("Error al realizar el retiro");
      }});
    }
